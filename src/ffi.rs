...
fn bindgen_test_layout__xmpp_mem_t() {
    ...
    fn test_field_alloc() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<_xmpp_mem_t>::uninit();
...
fn bindgen_test_layout__xmpp_log_t() {
    ...
    fn test_field_handler() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<_xmpp_log_t>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_xmpp_stream_error_t() {
    ...
    fn test_field_type() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<xmpp_stream_error_t>::uninit();
                let ptr = uninit.as_ptr();
    ...
    test_field_text();
    fn test_field_stanza() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<xmpp_stream_error_t>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).stanza) as usize - ptr as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
...
pub type xmpp_sockopt_callback = ::std::option::Option<
    unsafe extern "C" fn(
        conn: *mut xmpp_conn_t,
        sock: *mut ::std::os::raw::c_void,
    ) -> ::std::os::raw::c_int,
>;
extern "C" {
    pub fn xmpp_sockopt_cb_keepalive(
        conn: *mut xmpp_conn_t,
        sock: *mut ::std::os::raw::c_void,
    ) -> ::std::os::raw::c_int;
}
...
pub const xmpp_queue_element_t_XMPP_QUEUE_OLDEST: xmpp_queue_element_t = -1;
pub const xmpp_queue_element_t_XMPP_QUEUE_YOUNGEST: xmpp_queue_element_t = -2;
pub type xmpp_queue_element_t = ::std::os::raw::c_int;
extern "C" {
    pub fn xmpp_conn_send_queue_drop_element(
        conn: *mut xmpp_conn_t,
        which: xmpp_queue_element_t,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
...
extern "C" {
    pub fn xmpp_conn_set_sm_state(
        conn: *mut xmpp_conn_t,
        sm_state: *mut xmpp_sm_state_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
